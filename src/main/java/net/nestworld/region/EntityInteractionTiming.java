...
/**
 * Phase 11 #31.4 item-on-entity measurement-only diagnostics: how much wall time {@code
 * Entity.interact()}/{@code interactAt()} costs on each side, main thread (fallback path) vs.
 * region thread (the dispatched path). Same reasoning as {@link PlayerAttackTiming}/{@link
 * PlayerInteractionTiming}/{@link PlayerUseItemOnBlockTiming}.
 */
public final class EntityInteractionTiming {
    ...
    private EntityInteractionTiming() {}
