...
/**
 * Phase 11 #31.4 step 3 measurement-only diagnostics: how much wall time {@code
 * ServerPlayerGameMode.useItem()} costs on each side, main thread (fallback path) vs. region
 * thread (the dispatched path). Same reasoning as {@link PlayerAttackTiming}/{@link
 * PlayerInteractionTiming}.
 */
public final class PlayerUseItemTiming {
